...
export function Header({ mode, onModeChange }: HeaderProps) {
  return (
    <header className="w-full shrink-0 flex flex-col sm:flex-row items-center justify-between gap-2 sm:gap-6 py-3 sm:py-4 px-4 sm:px-6 md:px-12 z-10 relative">
